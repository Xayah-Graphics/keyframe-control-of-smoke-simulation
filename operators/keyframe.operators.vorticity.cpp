...
namespace kfs::operators {
    ...
    void Vorticity::operator()(field::CenteredVectorField3D& destination, const field::CenteredVectorField3D& source, const field::IndexedField3D& cell_indices, const boundary::PackedVectorBoundary3D& vector_boundary) {
